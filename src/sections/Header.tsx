					...
					<article className=" flex flex-col order-2 bg-gray-700/25 p-5 rounded-2xl     ">
						<span className="ring-gray-700/60 ring-1 p-7 rounded-xl">
							...
							<p className="  text-xl md:text-start  tracking-wide   text-wrap min-w-[350px] max-w-[630px] text-white p-5 ">
								...
								<span className="text-[#45b5ff]">
									Solutions
								</span>{' '}
								for modern problems trough web development.{' '}
								<br />
								Passionate about technology and the way
								things work as im constanly{' '}
								<span className="text-[#45b5ff]">
									Seeking
								</span>{' '}
							...
							<article className="text-end">
								<button className="hover:scale-105 font-title duration-100 tracking-wider text-lg   text-[#45b5ff]/60 px-4 py-2 mt-4 md:mt-0 rounded-lg hover:underline underline-offset-8">
									My Work
								</button>
