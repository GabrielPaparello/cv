...
import { Skeleton } from "@/components/Header/Skeleton";
  ...
  return (
    <>
      ...
      >
        ...
        {/* Use the skeleton loader component */}
        <section className={` ${isVideoLoaded ? "visible" : "invisible"}`}>
          <video
            id="bgVideo"
            autoPlay
            muted
        ...
        <section
          className={`relative flex lg:flex-row flex-col md:order-1 gap-5 m-5 text-start justify-evenly items-center ${
        ...
        >
          <article className="flex flex-col order-2 bg-gray-700/25 p-4 rounded-2xl">
            <span className="ring-gray-700/60 ring-1 md:p-7 p-3 rounded-xl">
              ...
              <p className="text-xl md:text-start tracking-wide min-w-[350px] max-w-[630px] text-white p-5">
                I specialize in creating{" "}
                <span className="text-[#45b5ff]">Solutions</span> for modern
                problems through web development. <br />
                Passionate about technology and the way things work as I`m
                constantly <span className="text-[#45b5ff]">Seeking</span> new
