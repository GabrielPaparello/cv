...
export const ProjectSection = () => {
  return (
    <div className="border-t-2 border-black bg-gradient-to-t from-[#0D1321] to-[#252b37]">
      <h2 className="text-3xl text-start my-10 ml-4 text-[#F7AB0A] font-semibold tracking-wide ">
        Projects
      </h2>
      <Projects
